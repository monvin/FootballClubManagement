...
<form action="staff_login.php" method="post" enctype="multipart/form-data">
  <table align="center" width="550" height="300" style="background-color:  grey;">
    <tr align="center">
      <td colspan="5"><h1 style="text-align:center">STAFFS</h1></td>
    </tr>

<tr>
      <td style="padding-right:5" align="right">STAFF:</td>
...
$get_admin="select * from staff where username='$admin_name' AND password='$admin_pass'";
...
$_SESSION['staff']=$admin_names;
echo "<script>alert('LOGIN SUCCESSFULL')</script>";
echo "<script>window.open('staff_area/staff.php','_self')</script>";
