...
<html>
<head>
	<title>INSERTING FAN PHOTO</title>
...
<form action="insert_fan.php" method="post" enctype="multipart/form-data">
...
$insert_movie="insert into fans(description,photo) values ('$description','$photo')";

$insert_mov= mysqli_query($con, $insert_movie);

if($insert_mov)
{
	echo "<script>alert('THE FAN PHOTO HAS BEEN INSERTED!')</script>";
	echo "<script>window.open('admin.php?if','_self')</script>";
}
