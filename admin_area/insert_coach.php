...
<form action="insert_coach.php" method="post" enctype="multipart/form-data">
...
$insert_movie="insert into coach(name,username,password,designation,section,age,nationality,salary,photo) values ('$name','$username','$password','$designation','$section','$age','$nationality','$salary','$photo')";

$insert_mov= mysqli_query($con, $insert_movie);

if($insert_mov)
{
	echo "<script>alert('THE COACH HAS BEEN INSERTED!')</script>";
	echo "<script>window.open('admin.php?ic','_self')</script>";
}
