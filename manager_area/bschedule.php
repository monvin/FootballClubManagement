...
<h1 style="text-align: center;">B Team Schedule</h1>
</center>
<?php
$con=mysqli_connect("localhost","root","","club");
$get_mov="select * from matches where team='B team' order by date DESC";
...
<h1 style='color:brown; font-size:20px;'>Tournament: $tournament</h1>
