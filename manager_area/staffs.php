...
<h1 style="text-align: center;">Staffs List</h1>
</center>
<?php
$con=mysqli_connect("localhost","root","","club");
$get_mov="select * from staff order by id desc";
...
<a href='sdetails.php?s_id=$id'><img width='240' height='240' src='../admin_area/images/$image'  style=' border: 2px solid grey;
    border-radius: 8px;'/></a>
<br>
<a href='sdetails.php?s_id=$id'><h4 style='color:rgb(0,69,135);'>$name</h4></a>
<br>
