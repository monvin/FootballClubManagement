...
<body style="background-image: url('background.jpg'); width: 100%;">
  <div>
<form action="coach_login.php" method="post" enctype="multipart/form-data">
  <table align="center" width="550" height="300" style="background-color:  grey;">
    <tr align="center">
      <td colspan="5"><h1 style="text-align:center">COACHES</h1></td>
    </tr>

<tr>
      <td style="padding-right:5" align="right">COACH:</td>
...
$get_admin="select * from coach where username='$admin_name' AND password='$admin_pass'";
...
$_SESSION['coach']=$admin_names;
echo "<script>alert('LOGIN SUCCESSFULL')</script>";
echo "<script>window.open('coach_area/coach.php','_self')</script>";
