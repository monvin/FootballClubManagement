...
<h1 style="text-align: center; ">Previous Opinions</h1>
</center>
<?php
$username=$_SESSION['staff'];
$con=mysqli_connect("localhost","root","","club");
$get_mov="select * from opinions where staff_username='$username' order by id desc";
...
<a href='profile.php'><img width='60' height='60' src='../admin_area/images/$image'  style=' border: 2px solid grey;
    border-radius: 8px;'/></a>
